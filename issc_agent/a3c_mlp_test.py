...
class A3CWorker(mp.Process):
    ...
    def run(self):
        self.A3CAgent0 = ISSCAgent("model.pth")
        self.A3CAgent2 = ISSCAgent("model.pth")
        self.agentList = [agents.SimpleAgent() for _ in range(4)]
...
class TestFunc():
    ...
    def run(self):
        ...
        a3c_workers = [A3CWorker(global_ep, res_dict, rew_queue,
                                 agent_input_dict_list[i], agent_return_dict_list[i], i) for i in range(1)]
